...
void detectorSigns()
{
	...
	for (size_t i = 0;; i++)
	{
		...
		/* UNNCESEEARY VISUALIZATION, COMMENTED OUT TO IMPROVE PERFORMNACE */
		// Write the detection type on frames
		// if (isStop)
		// 	cv::putText(full_frame,
		// 		cv::format("%s", "Stop sign"),
		// 		cv::Point(boundingBoxX + 580, boundingBoxY + 100),	// Coordinates
		// 		cv::FONT_HERSHEY_COMPLEX_SMALL,	// Font
		// 		1,	// Scale. 2.0 = 2x bigger
		// 		cv::Scalar(255, 0, 255));
		// else if (isOneTwenty)
		// 	cv::putText(full_frame,
		// 		cv::format("%s", "120 sign"),
		// 		cv::Point(boundingBoxX + 580, boundingBoxY + 100),	// Coordinates
		// 		cv::FONT_HERSHEY_COMPLEX_SMALL,	// Font
		// 		1,	// Scale. 2.0 = 2x bigger
		// 		cv::Scalar(255, 0, 255));
		...
		/* UNNCESEEARY VISUALIZATION, COMMENTED OUT TO IMPROVE PERFORMNACE */
		// Write info on frames
		// cv::putText(full_frame,
		// 	cv::format("Average FPS = %d", cvRound(1 / time_span.count())),
